...
// Only the columns addFavorite() actually persists are required. osm_type and
// tags are kept optional/loose: enriched or snapshot-rebuilt cards may carry
// non-string tag values or drop osm_type, and rejecting them surfaced as a
// "Impossible de mettre à jour les favoris" toast on otherwise-valid places.
