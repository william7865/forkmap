    ...
    >
      <div
        style={{
          ...
          animation: active ? 'enrichSweep 1.4s ease-in-out infinite' : 'none',
        }}
      />
    </div>
  )
    ...
    >
      <div
        style={{
          ...
          borderTop: '1.5px solid var(--forest-mid)',
          borderRadius: '50%',
              ...
              {nameQuery.length === 0 && recentSearches.length > 0 && (
                <>
                  ...
                  {recentSearches.map((s) => (
                    <div
                      key={s}
                      style={{ display: 'flex', alignItems: 'center', padding: '8px 12px', gap: 8 }}
                    >
                      <button
                        onMouseDown={() => {
                          setNameQuery(s)
        ...
        {!isMobile && (
          <button
            ...
            style={{
              ...
              color: 'var(--ink-40)',
              transition:
                'left 280ms var(--ease-out), background 150ms ease, color 150ms ease, border-color 150ms ease',
              flexShrink: 0,
              pointerEvents: 'all',
            }}
            onMouseEnter={(e) => {
          ...
          <ErrorBoundary
            fallback={
              ...
              >
                ...
                <p
                  style={{ margin: '0 0 6px', fontSize: 14, fontWeight: 600, color: 'var(--ink)' }}
                >
                  Carte indisponible
                </p>
                <button
