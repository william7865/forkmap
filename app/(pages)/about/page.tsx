  ...
  return (
    <InfoPage headerLabel="À propos">
      ...
      <div style={{ marginBottom: 52 }}>
        <div
          style={{
            ...
            border: '1px solid rgba(25,28,29,0.15)',
            borderRadius: 999,
            padding: '4px 14px',
            marginBottom: 18,
          }}
      ...
      <div
        style={{
          marginTop: 48,
          background: 'linear-gradient(135deg, rgba(25,28,29,0.15) 0%, rgba(25,28,29,0.04) 100%)',
          border: '1px solid rgba(25,28,29,0.15)',
          borderRadius: 18,
          padding: '28px 28px',
          display: 'flex',
      ...
      >
        ...
        <Link
          ...
          style={{
            ...
            fontSize: 13,
            fontWeight: 600,
            boxShadow: '0 4px 16px rgba(25,28,29,0.15)',
            flexShrink: 0,
