---
sha: 9969db8c463ee86b15a764b98eb47feda511c224
author: William
date: 2026-06-15 16:32:21 +0200
message: "ci: corrige le workflow Claude + retire l'intégration API Anthropic (#26)"
---

# Audit — 2026-06-15 14:32 · `9969db8`

> **ci: corrige le workflow Claude + retire l'intégration API Anthropic (#26)** — William

## Files changed

```
.github/workflows/claude-autofix.yml | 79 ------------------------------------
 CLAUDE.md                            |  3 +-
