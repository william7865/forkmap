---
sha: 3cfb4c8ea33a2a87ed1e100edee8261783a150c6
author: William
date: 2026-06-17 14:48:09 +0200
message: "Merge pull request #32 from william7865/feat/refonte-premium-surprends-moi"
---

# Audit — 2026-06-17 12:48 · `3cfb4c8`

> **Merge pull request #32 from william7865/feat/refonte-premium-surprends-moi** — William

## Files changed

```
app/(pages)/about/page.tsx         |  16 ++--
 app/(pages)/account/page.tsx       |   3 +-
 app/(pages)/attribution/page.tsx   |   2 +-
 app/(pages)/favorites/page.tsx     | 147 ++++++++++++++++++++++++++++-
 app/(pages)/help/page.tsx          |  16 ++--
 app/(pages)/privacy/page.tsx       |   4 +-
 app/(pages)/terms/page.tsx         |   2 +-
 app/api/contact/route.ts           |   2 +-
 app/api/favorites/route.ts         |  94 ++++++++++---------
 app/error.tsx                      |   2 +-
 app/layout.tsx                     |   4 +-
 app/page.tsx                       | 186 ++++++++++++++++++++++++-------------
 components/location/StartPanel.tsx |   4 +-
 components/map/MapView.tsx         |   3 +
 components/place/PlaceDetail.tsx   |   2 +-
 components/place/ShareModal.tsx    |   4 +-
 components/place/SurpriseSheet.tsx |  27 +++++-
 components/ui/BottomNav.tsx        |   3 +-
 components/ui/NavRail.tsx          |   3 +-
 lib/hooks/useHomeState.ts          |  84 ++++++++++++++++-
 20 files changed, 456 insertions(+), 152 deletions(-)
```
