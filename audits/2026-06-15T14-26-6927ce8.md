---
sha: 6927ce822c76c3acdefdc1aaa8eee1be8f58de68
author: William
date: 2026-06-15 16:25:40 +0200
message: "Merge pull request #25 from william7865/fix/coherence-audit"
---

# Audit — 2026-06-15 14:26 · `6927ce8`

> **Merge pull request #25 from william7865/fix/coherence-audit** — William
...
CLAUDE.md                               | 198 +++++++++++++----
 ...
 app/api/push-tokens/route.ts            |  46 ++--
 app/api/visits/route.ts                 |   6 +-
 eslint.config.mjs                       |   2 +
 lib/db.ts                               |  28 +++
 lib/hooks/useLists.ts                   |  17 +-
 lib/hooks/useMediaQuery.ts              |  27 +--
 lib/osm-enrichment.ts                   | 206 +++++++-----------
 package-lock.json                       | 189 ----------------
 package.json                            |   1 -
 sql/migrations/2026-06-15-coherence.sql |  54 +++++
 sql/schema.sql                          |  30 +--
 14 files changed, 480 insertions(+), 699 deletions(-)
```
