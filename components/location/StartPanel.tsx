      ...
      <div style={{ display: "flex", gap: 6 }}>
        ...
        <div style={{ flex: 1, position: "relative" }}>
          ...
          <span style={{
            ...
            {geoLoading
              ? <span style={{ width:12,height:12,border:"1.5px solid var(--ink-60)",borderTopColor:"transparent",borderRadius:"50%",animation:"spin 0.7s linear infinite",display:"inline-block" }}/>
              : <IcoSearch />
            }
          </span>
          ...
          {(query) && (
            <button onClick={clearAll} style={{
              ...
              color: "var(--ink-60)", padding: 3, display: "flex",
            }}>
              <IcoX />
            </button>
          )}
            ...
            <ul style={{
              ...
              {suggestions.slice(0, 5).map(s => {
                ...
                return (
                  ...
                  >
                    <span style={{ flexShrink:0, marginTop:3, color:"var(--ink-60)" }}><IcoPin /></span>
                    <span>
                      <span style={{ display:"block", fontSize:12, fontWeight:700, color:"var(--ink)", overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>
                        {primary.trim()}
                      </span>
        ...
        <button
          ...
          style={{
            ...
            background: locateError ? "var(--coral-pale)" : hasGpsLocation ? "#dcfce7" : "var(--off-white)",
