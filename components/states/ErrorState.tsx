...
export default function ErrorState({ title = 'Une erreur est survenue', message, onRetry }: Props) {
  return (
    <div
      style={{
        display: 'flex',
    ...
    >
      ...
      <div>
        <p style={{ margin: '0 0 5px', fontSize: 13, fontWeight: 700, color: 'var(--ink-80)' }}>
          {title}
        </p>
        {message && (
          <p
