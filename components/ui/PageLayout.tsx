...
export function ForkmapWordmark({ compact = false }: { compact?: boolean }) {
  return (
    <Link href="/" style={{ display: "flex", alignItems: "center", gap: compact ? 7 : 9, textDecoration: "none" }}>
  ...
  return (
    <div style={{
      ...
      <main style={{ flex: 1, background: "var(--white)" }}>
        <div style={{ maxWidth, margin: "0 auto", padding: "48px 24px 72px" }}>
          {children}
        </div>
      </main>
      <GlobalFooter />
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 18 }}>
            {[
              ...
              <Link key={l.href} href={l.href} style={{
                fontSize: 11, color: "var(--ink-20)", textDecoration: "none",
                transition: "color 120ms ease",
              }}
