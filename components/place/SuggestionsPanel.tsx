...
const IcoHeart = ({ f }: { f?: boolean }) => (
  <svg
    width="13"
    height="13"
    viewBox="0 0 24 24"
    fill={f ? 'var(--forest-mid)' : 'none'}
    stroke={f ? 'var(--forest-mid)' : 'currentColor'}
    strokeWidth="1.7"
    strokeLinecap="round"
...
const CUISINE_GRADIENTS: Record<string, string> = {
  japonais: 'linear-gradient(135deg,#0c2d3a,#1a6a9a)',
  sushi: 'linear-gradient(135deg,#0c2d3a,#1a6a9a)',
  italien: 'linear-gradient(135deg,#2d0e0e,#7c2222)',
  pizza: 'linear-gradient(135deg,#2d0e0e,#7c2222)',
  français: 'linear-gradient(135deg,#0e1e14,#2d6e3d)',
  french: 'linear-gradient(135deg,#0e1e14,#2d6e3d)',
  burger: 'linear-gradient(135deg,#1a0e00,#7c4800)',
  chinois: 'linear-gradient(135deg,#1a0505,#7a1515)',
  indian: 'linear-gradient(135deg,#1a0800,#b34d00)',
  mexicain: 'linear-gradient(135deg,#0a1a06,#3a7a0a)',
}
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '10px 14px 8px', display: 'flex', alignItems: 'center', gap: 7 }}>
        <span style={{ color: 'var(--amber)', display: 'flex', alignItems: 'center' }}>
          <IcoSparkle />
        </span>
        <div style={{ flex: 1 }}>
          <span
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: `1px solid ${isFav ? 'rgba(45,122,85,0.3)' : 'var(--ink-10)'}`,
