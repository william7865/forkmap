...
function ShareChannel({
  icon, label, sublabel, onClick, color = "var(--ink)", bg = "var(--off-white)", border = "var(--ink-10)"
}: {
  ...
  return (
    ...
    >
      ...
      <span style={{ fontSize: 11, fontWeight: 600, letterSpacing: "-0.01em", whiteSpace: "nowrap" }}>{label}</span>
      {sublabel && <span style={{ fontSize: 9, color: "var(--ink-40)", letterSpacing: "0.02em", whiteSpace: "nowrap" }}>{sublabel}</span>}
    </button>
  );
}
      ...
      >
        ...
        <div style={{ padding: "28px 20px 24px" }}>
          ...
          <p style={{
            ...
            color: "var(--ink-40)", letterSpacing: "0.12em",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
            ...
            <span style={{ fontSize: 10, color: "var(--ink-40)", letterSpacing: "0.08em", textTransform: "uppercase", fontWeight: 600 }}>ou copier le lien</span>
            <div style={{ flex: 1, height: 1, background: "var(--ink-10)" }}/>
          </div>
          ...
          <div style={{
            ...
            <span style={{
              flex: 1, fontSize: 11, color: "var(--ink-60)",
              overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
            }}>
          ...
          <a
            ...
            onMouseEnter={e => { e.currentTarget.style.background = "var(--off-white)"; e.currentTarget.style.color = "var(--ink)"; }}
            onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "var(--ink-60)"; }}
          >
            <IcoMap />
