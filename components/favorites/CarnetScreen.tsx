// ============================================================
// components/favorites/CarnetScreen.tsx — Le Carnet
//
// Extrait de app/(pages)/favorites/page.tsx pour pouvoir être rendu par DEUX
// routes : `/favorites` (le web, et les liens existants) et `/` en natif, où
// le Carnet est devenu l'écran d'accueil de l'app.
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    router.push(
                      `/carte?select=${encodeURIComponent(featured.osm_id)}&lat=${featured.lat}&lon=${featured.lon}`
                    )
                  }}
                  style={{
                    position: 'relative',
                        ...
                        <ListItemRowNative
                          ...
                          onOpenMap={() => {
                            if (snap?.lat != null && snap?.lon != null) {
                              ...
                              router.push(
                                `/carte?select=${encodeURIComponent(item.osm_id)}&lat=${snap.lat}&lon=${snap.lon}`
                              )
                            }
                          }}
                          onRemove={async () => {
