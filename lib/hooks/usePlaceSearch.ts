...
export interface PlaceSearchResult {
  /** Our canonical id: `${osm_type}/${osm_id}` (matches PlaceBase.osm_id). */
  osm_id: string
  name: string
  context: string // rest of the Nominatim display_name (address)
  lat: number
  lon: number
  category?: string // Nominatim `type` (restaurant, cafe, bar…)
}
